    ...
    return (
        <div className="max-w-6xl mx-auto space-y-6 sm:space-y-8 pb-12 animate-in fade-in duration-500">
            ...
            <DashboardPageHero
                ...
                titleFirst="Your"
                titleHighlight="Automated Series"
                description="Define your niche, schedule, and style. Our AI engines will handle the scripting, voicing, and rendering of your viral shorts."
                action={
