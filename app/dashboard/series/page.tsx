    ...
    if (loading) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[400px] text-white/20 gap-3">
                ...
                <p className="text-sm font-medium text-white/40">Loading your series...</p>
            </div>
        );
    }
    ...
    return (
        <div className="space-y-8">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-extrabold text-white mb-2">Automated Series</h1>
                    <p className="text-white/35 text-sm">Manage your video automation projects and triggers</p>
                </div>
            ...
            {series.length === 0 ? (
                <div className="bg-white/[0.02] border border-dashed border-white/10 rounded-2xl p-12 text-center">
                    <div className="w-16 h-16 bg-white/5 rounded-full flex items-center justify-center mx-auto mb-4">
                        <PlaySquare size={32} className="text-white/20" />
                    </div>
