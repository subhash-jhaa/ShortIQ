...
import { CreditCard, Zap, CheckCircle2, Crown, ArrowRight, Settings as SettingsIcon, Package, Sparkles, ChevronRight, Loader2 } from "lucide-react";
        ...
        <div className="max-w-6xl mx-auto space-y-6 sm:space-y-8 pb-12 animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 sm:gap-8">
                ...
                <div className="md:col-span-3 space-y-2">
                    ...
                    <div className="hidden md:block mt-8 p-6 rounded-2xl bg-gradient-to-br from-indigo-500/10 to-rose-500/10 border border-indigo-500/20">
                        <h4 className="text-indigo-900 dark:text-indigo-300 font-bold text-xs uppercase tracking-widest mb-3">Your Usage</h4>
                    ...
                    <div className="bg-white dark:bg-[#0d0d14] rounded-2xl sm:rounded-3xl border border-gray-200 dark:border-white/10 p-6 sm:p-8 md:p-10 shadow-sm min-h-[400px]">
                        ...
                        {activeTab === "overview" && (
                            <div className="space-y-6 sm:space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                ...
                                <div className="p-6 sm:p-8 rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-600 text-white relative overflow-hidden group">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                                    <div className="p-5 sm:p-6 rounded-2xl bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/5">
                                        <h4 className="text-sm font-bold text-gray-900 dark:text-white mb-2 flex items-center gap-2">
                                            <Zap size={16} className="text-indigo-500" /> Current Usage
                                        </h4>
                                    ...
                                    <div className="p-5 sm:p-6 rounded-2xl bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/5">
                                        <h4 className="text-sm font-bold text-gray-900 dark:text-white mb-2 flex items-center gap-2">
                                            <CheckCircle2 size={16} className="text-rose-500" /> Payment Method
                                        </h4>
                                        <p className="text-[10px] sm:text-xs text-gray-500 dark:text-white/40 mb-3 sm:mb-4">Managed via Clerk Billing</p>
                                        <button
                                            onClick={() => openUserProfile()}
                                            className="text-[10px] sm:text-xs font-black text-rose-500 uppercase tracking-widest hover:text-rose-600 transition-colors"
                                        >
                                            Update Details
                                        </button>
                                    </div>
                        ...
                        {activeTab === "pricing" && (
                            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                    {/* Free Plan */}
                                    <div className="bg-gray-50 dark:bg-white/[0.02] rounded-3xl border border-gray-200 dark:border-white/10 p-8 flex flex-col h-full relative group transition-all hover:border-indigo-500/30">
                                        <div className="mb-8">
                                    ...
                                    {/* Basic Plan */}
                                    <div className="bg-white dark:bg-indigo-500/5 rounded-3xl border-2 border-indigo-500/20 dark:border-indigo-500/30 p-8 flex flex-col h-full relative group transition-all hover:border-indigo-500 shadow-sm">
                                        <div className="mb-8">
                                        ...
                                        <button
                                            onClick={() => openUserProfile()}
                                            className="w-full py-4 px-6 rounded-2xl bg-indigo-500 text-white font-bold text-sm transition-all hover:bg-indigo-600 shadow-lg shadow-indigo-500/20 active:scale-[0.98]"
                                        >
                                            Subscribe
                                        </button>
                                    </div>
                                    ...
                                    {/* Advanced Plan */}
                                    <div className="bg-white dark:bg-[#0d0d14] rounded-3xl border border-gray-200 dark:border-white/10 p-8 flex flex-col h-full relative group transition-all hover:border-rose-500/50 shadow-sm">
                                        <div className="absolute top-0 right-8 -translate-y-1/2 bg-rose-500 text-white text-[10px] font-black px-4 py-1.5 rounded-full uppercase tracking-widest shadow-lg">
                                            RECOMMENDED
                                        </div>
                                        <div className="mb-8">
                                            <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2 flex items-center gap-2">
                                                Advanced <Sparkles size={16} className="text-rose-500" />
                                            </h3>
                                            <div className="flex items-baseline gap-1 mb-2">
                                            ...
                                            <div className="flex items-center gap-2 mb-6 text-[10px] text-gray-500 dark:text-white/40 font-bold uppercase tracking-wider">
                                                <div className="w-8 h-4 bg-rose-500 rounded-full relative">
                                                    <div className="absolute right-1 top-1 w-2 h-2 bg-white rounded-full" />
                                                </div>
                                                Billed annually
                                            </div>
