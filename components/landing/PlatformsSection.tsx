...
const platformData = [
    ...
    },
    {
        ...
        svg: (
            <svg viewBox="0 0 24 24" fill="white" className="w-7 h-7">
                <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 0 0-.79-.05 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34V8.78a8.17 8.17 0 0 0 4.78 1.52V6.84a4.85 4.85 0 0 1-1-.15z" />
            </svg>
        ),
    },
    {
...
export default function PlatformsSection() {
    return (
        <section id="platforms" className="py-28 relative">
            <div className="max-w-6xl mx-auto px-6">
                <div className="text-center mb-16">
                    <span className="section-badge">Multi-Platform</span>
                    <h2 className="section-heading mt-4">One tool. <span className="gradient-text">Every platform.</span></h2>
                    <p className="section-sub">
                        ShortIQ connects to all the platforms that matter, so you never have to choose.
                    </p>
                </div>
