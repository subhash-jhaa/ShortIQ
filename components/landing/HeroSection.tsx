...
export default function HeroSection() {
    ...
    const decorativeIcons = [
        { className: "left-[4%] md:left-[8%] top-[12%] md:top-[15%] w-24 h-24 md:w-36 md:h-36", content: (
        ...
        { className: "hidden md:block left-[15%] bottom-[15%] w-36 h-36", content: (
            <g transform="translate(80, 80)">
        ...
        { className: "hidden lg:block left-[28%] top-[12%] w-36 h-36", content: (
            <g transform="translate(80, 80)">
        ...
        { className: "right-[4%] md:right-[8%] top-[12%] md:top-[15%] w-24 h-24 md:w-36 md:h-36", content: (
            <g transform="translate(80, 80)">
        ...
        { className: "hidden md:block right-[15%] bottom-[15%] w-36 h-36", content: (
            <g transform="translate(80, 80)">
        ...
        { className: "hidden lg:block right-[28%] top-[12%] w-36 h-36", content: (
            <g transform="translate(80, 80)">
