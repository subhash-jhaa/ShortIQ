        ...
        <div className="flex flex-col gap-8 text-white">
            ...
            <div className="flex flex-col sm:flex-row items-end gap-3">
                ...
                <div className="relative flex flex-col gap-2 w-full sm:w-64" ref={dropdownRef}>
                    <label className="text-xs font-bold text-white/40 uppercase tracking-wider flex items-center gap-1.5 ml-1">
                        <Globe size={11} />
                        Select Language
                    </label>
                    ...
                    <button
                        ...
                        className="flex items-center justify-between gap-3 px-4 py-3 w-full
                                   rounded-xl bg-white/[0.05] border border-white/10 text-white
                    ...
                    >
                        <div className="flex items-center gap-2.5">
                            ...
                            <span className={`font-semibold text-sm ${currentLang ? "text-white" : "text-white/30"}`}>
                    ...
                    {dropdownOpen && (
                        <div
                            className="absolute top-full left-0 mt-2 w-full z-50
                                       bg-[#111114] border border-white/10 rounded-xl shadow-2xl
            ...
            {voicesLoading && (
                <div className="flex items-center justify-center gap-3 py-12">
                    ...
                    <span className="text-sm text-white/40 font-medium">Loading voices...</span>
                </div>
            )}
            ...
            {voiceResult && voiceResult.voices.length > 0 && (
                <div className="flex flex-col gap-4">
                    <div className="flex items-center justify-between">
                        <h3 className="text-sm font-bold text-white/50 uppercase tracking-wider">Available Voices</h3>
                        <span className="text-xs font-bold text-white/25 uppercase tracking-wider bg-white/5 px-3 py-1 rounded-lg border border-white/5">
                            ...
                            return (
                                <div
                                    ...
                                    className={`
                                        ...
                                        ${isSelected
                                            ? "bg-indigo-500/10 border-indigo-500 shadow-[0_0_20px_-5px_rgba(99,102,241,0.25)]"
                                ...
                                >
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <div className="flex items-center gap-2">
                                                <span className={`font-bold text-sm ${isSelected ? "text-white" : "text-white/80"}`}>
                                                    {voice.name}
                                                </span>
                                            ...
                                            <p className="text-xs text-white/25 mt-0.5">
                                                {voice.provider} · <span className="text-white/40">{voice.voiceId}</span>
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className={`
                                        ...
                                        ${isSelected
                                            ...
                                            : "bg-transparent border-white/10 group-hover:border-white/25"
                                        }
                                    `}>
